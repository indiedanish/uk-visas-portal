    ...
    const handleModalSubmit = async (data) => {
        try {
            if (modalActionType === 'add') {
                ...
                formData.append("displayFrequency", JSON.stringify({}));
        ...
        <div className="card">
            ...
            <div className="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                ...
                <div className="d-flex flex-wrap align-items-center gap-3">
                    ...
                    <Link onClick={handleAddClick} className="btn btn-sm btn-primary-600">
                                    ...
                                    {ad.content.map((content, contentIndex) => (
                                        <div key={content._id} className="ad-content">
                                            <a href={content.url} target="_blank" rel="noopener noreferrer">
                                                {content.type === 'image' ? (
                                                    <img src={content.url} alt="Ad Content" style={{ width: '50px', height: '50px' }} />
                                                ) : (
                ...
                <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 mt-24">
                    ...
                    <ul className="pagination d-flex flex-wrap align-items-center gap-2 justify-content-center">
                        <li className="page-item">
                            <Link className="page-link text-secondary-light fw-medium radius-4 border-0 px-10 py-10 d-flex align-items-center justify-content-center h-32-px me-8 w-32-px bg-base" to="#">
                                <Icon icon="ep:d-arrow-left" className="text-xl" />
                            </Link>
                        </li>
                        <li className="page-item">
                            <Link className="page-link bg-primary-600 text-white fw-medium radius-4 border-0 px-10 py-10 d-flex align-items-center justify-content-center h-32-px me-8 w-32-px" to="#">
                                1
                            </Link>
                        </li>
                        <li className="page-item">
            ...
            {isModalOpen && (
                <AdModal
                    isOpen={isModalOpen}
                    title={`${modalActionType.charAt(0).toUpperCase() + modalActionType.slice(1)} Ad`}
